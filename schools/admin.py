...
class LearningEnvironmentInline(admin.TabularInline):
...
#     #     ('Other Details', {
#     #         'classes': ('collapse',),
#     #         'fields': ('worker_name', 'worker_number', 'helper_name', 'helper_number', 'supervisor_name', 'supervisor_number', 'cdpo_name', 'cdpo_number')
#     #     }),
#     #     # ('Demographics', {
#     #     #     'classes': ('collapse',),
#     #     #     'fields': ('total_boys', 'total_girls', 'male_teachers', 'female_teachers')
#     #     # }),
#     #     # ('Safe Environment', {
#     #     #     'classes': ('collapse',),
...
# admin.site.register(SafeEnviroment)
