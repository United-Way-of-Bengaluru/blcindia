...
class SchoolListView(ListView):
	model = school
	template_name = 'managers/school_list.html'
...
class SchoolCreateView(TemplateView):
	template_name = 'managers/add_school.html'
...
class SchoolBasicFacilities_View(TemplateView):
	template_name = 'managers/BasicFacilities_View.html'
	http_method_names = ['get', 'post']
...
class SchoolperiodicUpdate_View(TemplateView):
	template_name = 'managers/periodicUpdate_school.html'
	http_method_names = ['get', 'post']
...
class SchoolDetailView(DetailView):
	model = school
	template_name = 'managers/school_detail.html'
