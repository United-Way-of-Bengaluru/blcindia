...
from fieldStaff.views import SchoolListView, SchoolDetailView, SchoolCreateView, SchoolperiodicUpdate_View, AddNewAddress, SchoolBasicFacilities_View, AddBasicFacilites
...
urlpatterns = [
    ...
    url(r'^basic_facilites/$', AddBasicFacilites.as_view({'get':'list','post': 'add'}), name='AddBasicFacilites'),
